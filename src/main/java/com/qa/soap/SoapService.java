...
public interface SoapService {
    ...
    @WebMethod
    String addAccount(String firstName, String secondName, String accountNumber); 
    
    @WebMethod
	String updateAccount(Long id, String firstName, String secondName, String accountNumber);
